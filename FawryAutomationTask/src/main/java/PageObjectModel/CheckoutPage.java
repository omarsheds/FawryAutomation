...
public class CheckoutPage {
    ...
    private By districtElement = By.id("address-ui-widgets-enterAddressDistrictOrCounty");
...
//    }
    ...
    public CheckoutPage enterFullName(String fullName) throws InterruptedException {
